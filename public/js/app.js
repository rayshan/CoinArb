...
(function() {
  ...
  angular.module('CaApp').factory('caNotificationSvc', function() {
    return {
      enabled: false,
  ...
  angular.module('CaApp').factory('caCheckAndCopySvc', function($rootScope, exchangeSvc, caNotificationSvc) {
    return {
  ...
  angular.module('CaApp').factory('caTickerSvc', function($resource, $filter, poller, caSocketSvc, exchangeSvc, caCheckAndCopySvc) {
  ...
  angular.module('CaApp').factory('caSocketSvc', function($rootScope, $filter, socketFactory, caCheckAndCopySvc) {
    var unsubscribe;
    unsubscribe = {
      depthBTCUSD: {
        op: 'unsubscribe',
